jQuery(document).ready(function ($) {
    ...
    $(".cases_edit_button").on("click", function (e) {
        ...
        $("#priority-dropdown-" + caseId).removeClass("hidden").focus();
        $("#priority-badge-" + caseId).addClass("hidden");

        $("#status-dropdown-" + caseId).removeClass("hidden").focus();
        $("#status-badge-" + caseId).addClass("hidden");

        $("#assigned-dropdown-" + caseId).removeClass("hidden").focus();
    ...
    $(".priority-dropdown").on("change", function () {
        ...
        badge.removeClass().addClass("inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium " +
            (newPriority === "high" ? "bg-red-100 text-red-800" :
                newPriority === "premium" ? "bg-yellow-100 text-yellow-800" :
