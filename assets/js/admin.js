jQuery(document).ready(function ($) {
    ...
    function showNotification(message, type = "success") {
        ...
        // Create icon wrapper
        const $iconWrapper = $(`
            <div style="min-width: 30px;" class="inline-flex items-center justify-center shrink-0 w-8 h-8 rounded-lg ${type === "success"
                ...
                <span class="sr-only">${type === "success" ? "Check icon" : "Error icon"
            }</span>
            </div>
        `);
        ...
        const $div = $(`
            <div data class="flex px-6 py-3 hover:bg-gray-100 space-x-4 relative notification-item" data-status="${status}">
                <div class="w-full ps-3">
                    <div class="${status === "unread" ? "text-gray-800" : "text-gray-500"
            } text-sm mb-1.5 ${status === "unread" && "font-bold"
            }">${cleanedMessage}</div>
                ...
                if (response.success) {
                    ...
                    <div class="border-b border-gray-200 pb-3 flex justify-between items-center">
                        <div>
                            ...
                            <span class="font-medium text-gray-800">${c.case_id
                        }</span>
                        ...
                        <div class="space-x-2 flex">
                            <span class="px-2 py-0.5 rounded-full text-xs font-medium ${c.case_status === "pending"
                            ? "bg-yellow-100 text-yellow-800"
                            : "bg-green-100 text-green-800"
                        }">${c.case_status}</span>
                            <span class="px-2 py-0.5 rounded-full text-xs font-medium ${c.payment_status === "pending"
                            ? "bg-red-100 text-red-800"
                            : "bg-green-100 text-green-800"
                        }">${c.payment_status.toLowerCase() === "pending" ? "Unpaid" : "Paid"
                        }</span>
                            <span class="px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">${c.assigned_to && c.assigned_to.trim() !== ""
                            ? c.assigned_to
                            : "N/A"
                        }</span>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="bg-gray-50 p-3 rounded-md space-y-2">
                            ...
                            <p><span class="font-normal text-gray-500">Name:</span> <span class="font-medium text-gray-800">${c.first_name
                        } ${c.last_name}</span></p>
                            <p><span class="font-normal text-gray-500">Email:</span> <span class="font-medium text-gray-800">${c.email
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Phone:</span> <span class="font-medium text-gray-800">${c.phone
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Birth Date:</span> <span class="font-medium text-gray-800">${c.birth_date
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Address:</span> <span class="font-medium text-gray-800">${c.address
                        }, ${c.city}, ${c.state} ${c.zip}</span></p>
                            <p><span class="font-normal text-gray-500">VA File Number:</span> <span class="font-medium text-gray-800">${c.va_file_number
                        }</span></p>
                        </div>
                        ...
                        <div class="bg-gray-50 p-3 rounded-md space-y-2">
                            ...
                            <p><span class="font-normal text-gray-500">Package Type:</span> <span class="font-medium text-gray-800">${c.package_type || "N/A"
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Package Price:</span> <span class="font-medium text-gray-800">${c.package_price || "N/A"
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Payment Amount:</span> <span class="font-medium text-gray-800">${c.payment_amount || "N/A"
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Payment Date:</span> <span class="font-medium text-gray-800">${c.payment_date || "N/A"
                        }</span></p>
                            <p><span class="font-normal text-gray-500">Payment Method:</span> <span class="font-medium text-gray-800">${c.payment_method || "N/A"
                        }</span></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-3 rounded-md space-y-2">
                        ...
                        ${c.service_history.length > 0
                            ...
                            <div class="p-2 border border-gray-200 rounded-md space-y-1">
                                <p><span class="font-normal text-gray-500">Branch:</span> <span class="font-medium text-gray-800">${sh.branch_of_service
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Composition:</span> <span class="font-medium text-gray-800">${sh.service_composition
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">MOS/AOC Rate:</span> <span class="font-medium text-gray-800">${sh.mos_aoc_rate || "N/A"
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Duty Position:</span> <span class="font-medium text-gray-800">${sh.duty_position || "N/A"
                                        }</span></p>
                            </div>
                        `
                                )
                        ...
                        ${c.va_claims.length > 0
                            ? c.va_claims
                                .map(
                                    (vc) => `
                            <div class="p-2 border border-gray-200 rounded-md space-y-1">
                                <p><span class="font-normal text-gray-500">Condition:</span> <span class="font-medium text-gray-800">${vc.condition
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Claim Type:</span> <span class="font-medium text-gray-800">${vc.claim_type
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Primary Event:</span> <span class="font-medium text-gray-800">${vc.primary_event || "N/A"
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Service Explanation:</span> <span class="font-medium text-gray-800">${vc.service_explanation || "N/A"
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">MTF Seen:</span> <span class="font-medium text-gray-800">${vc.mtf_seen === "1" ? "Yes" : "No"
                                        }</span></p>
                                <p><span class="font-normal text-gray-500">Current Treatment:</span> <span class="font-medium text-gray-800">${vc.current_treatment || "N/A"
                                        }</span></p>
                            </div>
                        `
                                )
                    ...
                    <div class="bg-gray-50 p-3 rounded-md space-y-2">
                        ...
                        ${c.documents.length > 0
                            ...
                            <div class="flex justify-between items-center p-2 border border-gray-200 rounded-md">
                                <p><span class="font-normal text-gray-500">${doc.document_type
                    ...
                    <div class="bg-gray-50 p-3 rounded-md space-y-1">
                        ...
                        <p><span class="font-normal text-gray-500">Data Collection:</span> <span class="font-medium text-gray-800">${c.consent_data_collection === "1"
                            ? "Agreed"
                            : "Not agreed"
                        }</span></p>
                        <p><span class="font-normal text-gray-500">Privacy Policy:</span> <span class="font-medium text-gray-800">${c.consent_privacy_policy === "1"
                            ? "Agreed"
                            : "Not agreed"
                        }</span></p>
                        <p><span class="font-normal text-gray-500">Communication:</span> <span class="font-medium text-gray-800">${c.consent_communication === "1"
                            ? "Agreed"
                            : "Not agreed"
                        }</span></p>
                    </div>
